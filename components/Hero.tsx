...
export const Hero: React.FC = () => {
  return (
    <div className="relative h-[60vh] min-h-[500px] w-full bg-stone-900 overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center text-sm font-medium text-white">
          <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
            <Clock className="w-4 h-4 mr-2 text-amber-400" aria-hidden="true" />
            <span>{CAFE_DATA.hours}</span>
          </div>
          <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
            <MapPin className="w-4 h-4 mr-2 text-amber-400" aria-hidden="true" />
            <span>Fès, Maroc</span>
          </div>
        </div>
      </div>
